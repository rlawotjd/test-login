...
<div class="page_content  steam">
							...
							<div id="captcha_entry" style="display: none">
								...
								<div id="captcha_entry_text">
									<input type="hidden" id="captchagid" name="captchagid" value="" />
										<div class="form_area">
											<img id="captchaImg" src="https://store.cloudflare.steamstatic.com/public/shared/images/trans.gif" border="0">
											<br><br>
											<label for="captcha_text">위에 있는 문자들을 입력해주세요.</label>

											<input type="text" name="captcha_text" id="captcha_text" />
										</div>
										<div class="form_notes" style="padding-top: 10px;">
											<label for="captcha_text">
												<a id="captchaRefreshLink" href="javascript:RefreshCaptcha()">새로고침</a>
												<a href="javascript:RefreshCaptcha()" style="text-decoration: none;">
													<img id="captchaRefreshImg" src="https://store.cloudflare.steamstatic.com/public/shared/images/ico_captcha_refresh.gif" border="0" />
												</a>
											</label>
										</div>
									<div style="clear: left;"></div>
	...
	<p><a name="0"></a>Table of contents:
		<ol style="margin-left: 13px;">
			...
			<li><a href="#10">Applicable law/mediation/jurisdiction/attorney’s fees</a></li>
	...
	<p>SECTION 11 CONTAINS A BINDING ARBITRATION AGREEMENT AND CLASS ACTION WAIVER. IT AFFECTS HOW DISPUTES ARE RESOLVED. PLEASE READ IT. IF YOU ARE A CONSUMER AND LIVE IN THE PROVINCE OF QUEBEC (CANADA), THE EUROPEAN UNION, OR THE UNITED KINGDOM, SECTION 11 DOES NOT APPLY TO YOU.</p>
	...
	<p>1. REGISTRATION AS A SUBSCRIBER; APPLICATION OF TERMS TO YOU; YOUR ACCOUNT, ACCEPTANCE OF AGREEMENTS<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		...
		<p>You become a subscriber of Steam ("Subscriber") by completing the registration of a Steam user account.  This Agreement takes effect as soon as you indicate your acceptance of these terms.  You may not become a Subscriber if you are under the age of 13.  Steam is not intended for children under 13 and Valve will not knowingly collect personal information from children under the age of 13. Additional age restrictions may apply in your country.</p>
			<p>A. Contracting Party</p>
				<p>For any interaction with Steam your contractual relationship is with Valve. Except as otherwise indicated herein or at the time of the transaction (such as in the case of purchases from another Subscriber in a Subscription Marketplace), any transactions for Subscriptions (as defined below) you make on Steam are being made from Valve.</p>
	...
	<p>3. BILLING, PAYMENT AND OTHER SUBSCRIPTIONS<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		<p>All charges incurred on Steam, and all purchases made with the Steam Wallet, are payable in advance and final, except as described in Sections 3.I and 7 below.</p>
			...
			<p>D. Trading and Transactions of Subscriptions Between Subscribers</p>
				<p>Steam may include  one or more features or sites that allow Subscribers to trade, offer or order certain types of Subscriptions (for example, license rights to virtual items) with, to or from other Subscribers ("Subscription Marketplaces"). An example of a Subscription Marketplace is the Steam Community Market. By using or participating in Subscription Marketplaces, you authorize Valve, on its own behalf or as an agent or licensee of any third-party creator or publisher of the applicable Subscriptions in your Account, to transfer those Subscriptions from your Account in order to give effect to any trade or sale you make.</p>
				<p>Valve may charge a fee for trades or sales in a Subscription Marketplace.  Any fees will be disclosed to you prior to the completion of the trade or sale.</p>
				<p>If you complete a trade, sale or order in a Subscription Marketplace, you acknowledge and agree that you are responsible for taxes, if any, which may be due with respect to your transactions, including sales or use taxes, and for compliance with applicable tax laws.  Proceeds from sales you make in a Subscription Marketplace may be considered income to you for income tax purposes.  You should consult with a tax specialist to determine your tax liability in connection with your activities in any Subscription Marketplace.</p>
	...
	<a name="4"></a>
	<p>4. ONLINE CONDUCT, CHEATING AND PROCESS TAMPERING<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		...
		<p>You agree that you will not tamper with the execution of Steam or Content and Services unless otherwise authorized by Valve. You acknowledge and agree that either Valve or any host of an online multiplayer game distributed through Steam ("External Host") may refuse to allow you to participate in certain online multiplayer games if you use Cheats or tamper with the execution of Steam or the Content and Services.</p>
		<p>Further, you acknowledge and agree that External Hosts may report your use of Cheats or unauthorized process tampering to Valve, and Valve may communicate your history of use thereof to External Hosts within the boundaries of the Steam Privacy Policy.</p>
		<p>Valve may restrict or terminate your Account or a particular Subscription for any conduct or activity that is illegal, constitutes a Cheat, or breaches the Steam Online Conduct Rules. You acknowledge that Valve is not required to provide you notice before terminating your Subscription(s) and/or Account.</p>
		<p>You may not use Cheats, automation software (bots), mods, hacks, or any other unauthorized third-party software, to modify or automate any Subscription Marketplace process, the process of Steam account creation or otherwise in interacting with or controlling the processes or user interface of Steam, except to the degree expressly permitted.</p>
	...
	<p>9. TERM AND TERMINATION<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
			...
			<p>D. Survival of Terms</p>
				<p>Sections 2.C., 2.D., 2.F., 2.G., 3.A., 3.B., 3.D., 3.H., and 5 - 12 will survive any expiration or termination of this Agreement.</p>
	
	<a name="10"></a>
	<p>10. APPLICABLE LAW/MEDIATION/JURISDICTION/ATTORNEYS’ FEES<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		<p>For All Subscribers Outside the European Union and United Kingdom:</p>
		<p>You and Valve agree that this Agreement shall be deemed to have been made and executed in the State of Washington, U.S.A., and Washington law, excluding conflict of laws principles and the Convention on Contracts for the International Sale of Goods, governs all claims arising out of or relating to: (i) any aspect of the relationship between us; (ii) this Agreement; or (iii) your use of Steam, your Account or the Content and Services; except that the U.S. Federal Arbitration Act governs arbitration as far as your country’s laws permit. Subject to Section 11 (Dispute Resolution/Binding Arbitration/Class Action Waiver) below, you and Valve agree that any claim asserted in any legal proceeding shall be commenced and maintained exclusively in any state or federal court located in King County, Washington, having subject matter jurisdiction. You and Valve hereby consent to the exclusive jurisdiction of such courts. In any dispute arising out of or relating to this Agreement, your use of Steam, your account, or the Content and Services, the prevailing party will be entitled to attorneys’ fees and expenses (except arbitration -- see Section 11.C.)</p>
		...
		<p>In the event of a dispute relating to the interpretation, the performance or the validity of the Subscriber Agreement, an amicable solution may be sought before any legal action. You can file your complaint at <a style="text-decoration:underline;" href="http://help.steampowered.com">http://help.steampowered.com</a>. The European Commission provides an Online Dispute Resolution website for EU consumers at <a style="text-decoration:underline;" href="https://ec.europa.eu/consumers/odr">https://ec.europa.eu/consumers/odr</a>. Participation in this website is not available to US companies, which is why Valve is not registered there. However, insofar as your complaint concerns the behavior of Valve’s data protection representative Valve GmbH you can file your complaint there.</p>
		<p>In the event that an Alternative Dispute Resolution Procedure fails, or if either Valve or you prefer not to resort to Alternative Dispute Resolution, you may bring proceedings in the courts of the place where you are domiciled.</p>
	
	<a name="11"></a>
	<p>11. DISPUTE RESOLUTION/BINDING ARBITRATION/CLASS ACTION WAIVER<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		<p>This Section 11 shall apply to the maximum extent permitted by applicable law. IN PARTICULAR, IF YOU ARE A CONSUMER WHO LIVES IN A EUROPEAN UNION MEMBER COUNTRY, THE UNITED KINGDOM, THE PROVINCE OF QUEBEC (CANADA), AUSTRALIA, OR NEW ZEALAND, THIS SECTION 11 DOES NOT APPLY TO YOU. IF YOU ARE A CONSUMER WHO LIVES IN RUSSIA,YOU MAY UTILIZE THE ARBITRATION PROCESS IDENTIFIED IN THIS SECTION 11 OR YOU MAY USE LOCAL RUSSIAN STATE COURTS TO RESOLVE YOUR DISPUTE.</p>
	...
	<p>12. MISCELLANEOUS<a href="#0" style="text-decoration: none;"><small style="color: #666;">  &#9206;</small></a></p>
		...
		<p>This Agreement was last updated on April 25, 2023 ("Revision Date"). If you were a Subscriber before the Revision Date, it replaces your existing agreement with Valve or Valve SARL on the day that it becomes effective according to Section 8 above.</p>
</div>											</div>
